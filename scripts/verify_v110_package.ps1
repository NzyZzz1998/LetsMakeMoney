...
if ($ExpectedVersion -ne "1.1.0") {
    throw "v1.1.0 package verification cannot validate version '$ExpectedVersion'."
}
...
if ($LASTEXITCODE -ne 0) {
    throw "v1.1.0 $Mode package identity verification failed with exit code $LASTEXITCODE"
}
