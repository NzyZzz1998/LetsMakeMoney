...
$PackageName = "LetsMakeMoney-v0.4-beta-windows-x86_64"
$ReleaseDir = Join-Path $ProjectRoot "releases\v0.4"
...
$packageFiles = @(
    ...
    @{ Source = "releases\v0.4-beta-notes.md"; Target = "release-notes.md"; Role = "release_notes" }
)
...
Write-Host "v0.4 package created: $ZipPath"
