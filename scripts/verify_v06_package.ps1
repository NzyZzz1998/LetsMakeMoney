...
$version=Get-LetsMakeMoneyVersion -ProjectRoot $ProjectRoot;if(-not $PackagePath){$PackagePath=Join-Path $ProjectRoot "releases/v0.6/LetsMakeMoney-v$version-windows-x86_64.zip"}
