...
> 状态：旧干净候选已因 `V110-BUG-001` 淘汰；修复后的最终干净候选已经构建并通过自动门禁，真实桌面结论为部分通过，未发布。
...
最终 Candidate ID：`V110-20260813T042624Z-7eb9f88d-clean`；Zip SHA256：`0E6757775658929E89CF158E97FA5AEBBCCA2CEBFB63F35F574F567845AD96A3`。
