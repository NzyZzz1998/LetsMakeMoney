...
> 状态：`V110-BUG-003` 至 `V110-BUG-007` 已进入 clean 候选。项目所有者确认贴边自动隐藏明显改善；本轮允许推送和重新打包，tag 与 Release 仍冻结。
...
定向真实 GUI：项目所有者在 `V110-20260817T114653Z-00ac5389-clean` 上确认贴边自动隐藏“现在好多了”，首次收起不再依赖额外点击；因未逐次报告左右各 10 次结果，上述统计门禁保持未勾选。
