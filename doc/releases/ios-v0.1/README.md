...
1. [`status.md`](status.md)：当前状态、阻塞原因、恢复开发所需条件和下一步。
2. [`progress_ios-v0.1.md`](progress_ios-v0.1.md)：各里程碑最小任务与真实完成度。
3. [`prd.md`](prd.md)：产品范围、计算规则和验收口径。
4. [`dev_plan_ios-v0.1.md`](dev_plan_ios-v0.1.md)：实施顺序、风险、门禁和回退方式。
5. [`m4-device-verification.md`](m4-device-verification.md)、[`m5-device-verification.md`](m5-device-verification.md)、[`m6-device-verification.md`](m6-device-verification.md)：Mac 到位后的真机验证入口。
