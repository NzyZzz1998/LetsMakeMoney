...
**当前开发分支**：`main`；下一版本宠物动作方向尚处于 Review

**当前阶段**：v0.8 Beta 已通过 PR #3 合并至 `main`，annotated tag 与 GitHub Pre-release 已发布；下一版本宠物动作优化仅进入 Review，尚未形成正式需求
...
1. [当前状态](current.md)
2. [v0.8 版本级验证](releases/v0.8/verification.md)
3. [v0.8 发布说明](releases/v0.8/release-notes.md)
4. [v0.8 人工验证](releases/v0.8/manual-verification.md)
5. [v0.8 薪资与作息验证](releases/v0.8/salary-schedule-verification.md)
6. [v0.8 工程治理 Review](releases/v0.8/engineering-governance-review.md)
7. [宠物动作与 PetManager 深度 Review](releases/v0.8/pet-animation-next-version-review.md)
8. [v0.7 发布状态](releases/v0.7/current.md)
