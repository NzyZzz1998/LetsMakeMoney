...
| 当前里程碑 | v1.0.F / v1.0.8 最终人工补证与发布授权 |
| 总体状态 | 唯一候选、自动门禁和 GUI 验收完成；托盘真实鼠标流程待补证；当前不可发布 |
...
v1.0.F 是 v1.0 系列收官质量版本的内部代号，公开版本固定为 `v1.0.8`。本地发布源提交 `81abae364ad577a394c3c9dcda3a1d1c15e83b99` 已生成唯一候选 `V10F-20260804-final-81abae36`；Zip SHA256 为 `07D9B1766CECE8DA092CE31C234E6018D4820049F3D2A310033478BF5EB69DDA`。M1-M7、候选身份、核心 GUI、浅深主题和 Windows 11 单显示器 100%/125%/150% DPI 已通过；Windows 通知区真实鼠标流程仍待项目所有者补证，因此当前不可发布。当前没有执行 push、远端 tag 或 GitHub Release，也没有发布授权。
