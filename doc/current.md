...
| 当前里程碑 | Classic-only 桌面陪伴回归进入 v1.1.0 干净候选构建与发布前补证 |
...
- 当前产品候选包为 `0.4.0-rc.1`，manifest SHA256 `9E50542B436D197F0CD5CB8CD7149B6E0C57EE9A12073DF2A2E5B588719992AC`，package tree SHA256 `BC62C560134CD240015ABE742DAFA9E76D80196412C73C60423BD173A3548EA1`；状态为 `approved / ready:true / productReturnApproved:true / published:false`。
