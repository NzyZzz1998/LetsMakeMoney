...
当前公开版本为 **v1.0.5 Stable**；仓库正在开发 **v1.0.6** 主题初始化维护版本。v1.0.6 尚未完成独立候选验收，也不是已发布版本。
...
- v1.0.6 正在修复浅色配置下辅助窗口可能采用旧深色缓存的问题，并补齐首帧、跨窗口 ThemeSession 与配置 hydration 门禁；状态以 [v1.0.6 进度](doc/releases/v1.0.6/progress_v1.0.6.md) 为准。
