...
当前开发版本为 **v0.5 Beta 验收阻塞态**，当前分支为 `main`。最新事实源请先阅读 `doc\current.md` 和 `doc\releases\v0.5\status.md`。
...
- 开机自启、配置持久化、窗口位置保存
- v0.5 自动验证、打包脚本、发布包 manifest/checksum 和手动验证文档

v0.5 仍有发布阻塞项，不能视为正式发布完成。当前待验证内容以 `doc\releases\v0.5\verification.md` 为准：纯桌宠模式下托盘左键隐藏/恢复后，桌宠应恢复且任务栏入口应保持隐藏。
...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\package_v05.ps1
powershell -ExecutionPolicy Bypass -File .\scripts\verify_v05_package.ps1
```
...
- 当前入口: `doc\current.md`
- v0.5 文档索引: `doc\releases\v0.5\README.md`
- v0.5 PRD: `doc\releases\v0.5\prd.md`
- v0.5 实施计划: `doc\releases\v0.5\dev_plan_v0.5.md`
- v0.5 进度: `doc\releases\v0.5\progress_v0.5.md`
- v0.5 验证文档: `doc\releases\v0.5\verification.md`
- v0.5 发布前检查: `doc\releases\v0.5\release-checklist.md`
...
- v0.5 发布说明: `releases\v0.5-beta-notes.md`
...
| v0.5 Beta | 验收阻塞态 | Settings/Wizard 共享控件、托盘恢复、点击穿透保护、文档治理和发布包验证 |
